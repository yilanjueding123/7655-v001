...
#define PERI_ADP_OUT_PWR_OFF_TIME       128/PERI_TIME_INTERVAL_AD_DETECT //15s	//wwj modify from 15sec to 5sec
...
extern void TvOutSwitch_With_UsbMode(INT8U mode);
