...
void gp_Cdsp_SetAWBYUV_test(const INT16S *AwbTable)
{
	gpCdspAWB_t awb;
	...
	awb.UL1N1 = AwbTable[19]; 
	awb.UL1P1 = AwbTable[20]; 
	awb.VL1N1 = AwbTable[21]; 
	awb.VL1P1 = AwbTable[22]; 
       
	awb.UL1N2 = AwbTable[23]; 
	awb.UL1P2 = AwbTable[24]; 
	awb.VL1N2 = AwbTable[25]; 
	awb.VL1P2 = AwbTable[26]; 
       
	awb.UL1N3 = AwbTable[27]; 
	awb.UL1P3 = AwbTable[28]; 
	awb.VL1N3 = AwbTable[29]; 
	awb.VL1P3 = AwbTable[30]; 
	
	gpCdspSetAWB(&awb);
}


void gp_Cdsp_SetAWBYUV_test2(void)
{
	gpCdspAWB_t awb;
			...
			{		
				...
				if(awb_frame >= 2)
				{
					...
					*/
					...
					if((ret == AWB_SUCCESS_CVR) && (awbmode == AWB_AUTO_FIRST_SEARCH))
					{
						gp_Cdsp_SetAWBYUV_test2();
